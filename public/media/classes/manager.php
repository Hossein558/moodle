...
final class core_media_manager {
     ...
     *
     * Iterates through available media players to find one that can handle the URL,
     * and returns the HTML generated by that player.
     *
     ...
     *
     * Provides multiple sources of the same media so the browser or player can
     * select the most appropriate format to play.
     *
